...
public class RootApplication extends Application {
    ...
    static {
        ...
        AREA_MONSTER_FILL.put("OrcCave1", List.of("152", "155"));
        AREA_MONSTER_FILL.put("OrcCave2", List.of("152", "155"));
        AREA_MONSTER_FILL.put("OrcCave3", List.of("152", "155"));
        AREA_MONSTER_FILL.put("OrcCave4", List.of("152", "155"));
    }
